...
In the table you can see that the mean and the median are higher when countries did not have any revolutions. But, relatively seen they are both quite close to each other. But what is interesting is that the highest growth is from a country that has suffered from a revolution. 
